...
export default function DreamInsightModal({ dream, isOpen, onClose }: DreamInsightModalProps) {
    ...
    const handleShare = async () => {
        if (typeof window === 'undefined' || !artifactRef.current) return;
        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    >
                        <Card className="bg-background border-white/10 overflow-hidden relative">
                            {/* Close Button */}
                            ...
                            <div className="grid md:grid-cols-2 gap-0">
                                ...
                                <div className="p-6 space-y-6">
                                    ...
                                    <p className="text-foreground leading-relaxed font-serif text-lg tracking-wide">{dream.content}</p>
                                    ...
                                    {/* MEMORY CORE: RELATED DREAMS */}
                                    <RelatedMemories content={dream.content} currentId={dream.id} />
                                </div>
                            </div>
                        </Card>
                    </motion.div>
